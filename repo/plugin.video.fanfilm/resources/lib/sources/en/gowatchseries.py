...
class source:
    def __init__(self):
        ...
        self.session = (requests.Session())  # self.search_link = '/ajax-search.html?keyword=%s&id=-1'
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            if "tvshowtitle" in data:
                ...
                t = [i for i in r if cltitle == cleantitle.get(i[0]) or cltitle2 == cleantitle.get(i[0])]
                ...
                t = [i for i in r if cltitle2 == cleantitle.getsearch(i[0]) or cltitle == cleantitle.getsearch(i[0])]
            ...
            log_utils.log("gowatchseries - Exception %s " % e, "sources")
            return sources
