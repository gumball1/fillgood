...
class source:
    def __init__(self):
        ...
        self.search_link = "/searchtest.php"  # self.user = control.setting('streamlord.user')  # self.password = control.setting('streamlord.pass')
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            sources.append({"source": "cdn", "quality": quality, "language": "en", "url": url, "direct": True,
                "debridonly": False, })

            return sources
        except:
            log_utils.log("streamlord_exc0", "sources")
            return sources
