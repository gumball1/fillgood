...
from ptw.libraries import client, cleantitle, source_utils, log_utils
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ["en"]
        self.domains = ["www8.putlockers.fm",
            "putlocker.unblockit.ch", ]  # cloudflare'd: 'kat.mn', 'www2.putlockers.gs', 'putlockerfree.net', '123putlocker.io'
    ...
    def movie(self, imdb, title, localtitle, aliases, year):
        try:
            ...
            log_utils.log("plockers0 Exception", "sources")
            return
    ...
    def tvshow(self, imdb, tvdb, tvshowtitle, localtvshowtitle, aliases, year):
        try:
            ...
            log_utils.log("plockers1 Exception", "sources")
            return
    ...
    def episode(self, url, imdb, tvdb, title, premiered, season, episode):
        try:
            ...
            log_utils.log("plockers2 Exception", "sources")
            return
    ...
    def sources(self, url, hostDict, hostprDict):
        ...
        try:
            ...
            for p in _posts:
                try:
                    post = (client.parseDOM(p, "a", ret="href")[1], client.parseDOM(p, "a")[1],
            ...
            if "tvshowtitle" in data:
                ...
                link = \
                [i[0] for i in posts if cleantitle.get_title(title) in cleantitle.get_title(i[1]) and hdlr == i[2]][0]
            ...
            try:
                ...
                try:
                    ...
                    if valid:
                        sources.append(
                            {"source": hoster, "quality": "SD", "language": "en", "url": url.replace("\/", "/"),
                                "direct": False, "debridonly": False, })
                except:
                    log_utils.log("plockers4 Exception", "sources")
                    pass
            except:
                log_utils.log("plockers3 Exception", "sources")
                pass
            ...
            if r:
                for i in r:
                    try:
                        ...
                        log_utils.log("plockers5 Exception", "sources")
                        pass
            return sources
        except:
            log_utils.log("plockers Exception", "sources")
            return sources
    ...
    def resolve(self, url):
        if any(x in url for x in self.domains) or "putlocker" in url:
            try:
                ...
                log_utils.log("plockersR Exception", "sources")
