...
patterns = [
    ...
    (
        "quality",
        (
            r"((?:PPV\.)?[HP]DTV|(?:PPV|VOD)(?:Rip)?|(?:HD|HQ)?CAM|CamRip|(?<!D)(?:HD[.-]?)?T[SC]|tsrip|"
            "(?:PPV )?WEB[ .-]?(?:DL)?(?: DVDRip)?|HDRip|(?:HD)?TVRip|(?:HD|HQ)?DV[DB][.-]?Rip|DCP[.-]?Rip|"
            "WE?B[ .-]?Rip|Blu[.-]?Ray|B[DR]?[.-]?(?:Rip|Remux|R|D)|DVD(?:Rip|Scr)?|hdtv|telesync|telecine|screener|scr|R5)"
        ),
    ),
    ...
    ("audio",
        r"((?:WMA|OPUS|FLAC|L?PCM|DDP?A?(?:[.-]?EX|\+)?|DTS(?:[ .-]?(?:HD|ES|EX|X(?:LL)?(?!26))(?:[. ]?MA)?)?|E?-?AC-?3|(?:HE-)?AAC(?:[ .-]LC|v2)?|TRUE[ .-]?HD(?:[ .]atmos)?|atmos)(?:[ .-]?[572461]\.[102])?(?:(?:\.[24])?[ .]atmos)?"
